...
export default function Content({children}) {
    ...
    return (
        <div className="h-screen flex bg-gradient-to-r from-blue-500 from-10% via-sky-500 via-30% to-cyan-500 to-90%">
            <Nav />
            <div className="min-h-[540px] h-fit flex-grow m-2 p-4 bg-white/60 rounded-md border-white/30 border-4">
                {children}
            </div>
        </div>
    )
