...
export default function Orders() {
    ...
    async function deleteOrder() {
        console.log('Delete order:', chosenProductToDelete)
        /*
    ...
    function totalOrderPrice(order) {
        ...
        for(const orderProduct of order.orderProducts) {
            let unitPrice = orderProduct.price_data.unit_amount/100;
            totalPrice += (orderProduct.quantity * unitPrice)
        }
        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg mt-10">
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <>
                        {orders.map(order => (
                            <tr className="bg-white/80 border-b dark:bg-gray-800 dark:border-gray-700" key={order._id}>
                                ...
                                <td className="px-6 py-4">
                                    <div className={"w-fit py-0.5 px-3 rounded-xl text-white font-bold label-status-" + order?.status}>
                                        {order?.status}
                                    </div>
                                </td>
                                <td className="px-6 py-4 text-right">
                                    ...
                                    <button 
                                        ...
                                        onClick={(e) => showDeletePopup(order._id)}>
                                        Delete
                                    </button>
                                </td>
                            </tr>
